...
(deftest iso8601-zoned-datetime-string?-as-predicate
  (dt-test-cases/assert-cases-satisfied-by dt-time/iso8601-zoned-datetime-string?
    (dt-test-cases/true-case "any extended format UTC offset datetime string"
      :samples ["1986-09-20T16:34:56.123Z"
                "2025-11-10T11:14:56Z"
                "2036-10-15T01:00Z"
                "+12050-12-25T13:00:00.000000Z"])
    (dt-test-cases/true-case "any extended format non-UTC offset datetime string"
